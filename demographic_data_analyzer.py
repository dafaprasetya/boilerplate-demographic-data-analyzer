...
def calculate_demographic_data(print_data=True):
    ...
    laki = df[df['sex'] == 'Male']
    average_age_men = laki['age'].mean()

    # What is the percentage of people who have a Bachelor's degree?
    def persentase_gelar(gelar):
        sarjana_ngoding = df[df['education'] == gelar].shape[0]
        total = df.shape[0]
        return (sarjana_ngoding / total)*100

    percentage_bachelors = persentase_gelar('Bachelors')
